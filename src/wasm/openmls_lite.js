/* @ts-self-types="./openmls_lite.d.ts" */
...
export class Client {
     ...
     */
    create_group() {
        const ret = wasm.client_create_group(this.__wbg_ptr);
        if (ret[2]) {
    ...
    export_storage_snapshot() {
        const ret = wasm.client_export_storage_snapshot(this.__wbg_ptr);
        if (ret[3]) {
     ...
     */
    import_storage_snapshot(snapshot) {
        const ptr0 = passArray8ToWasm0(snapshot, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.client_import_storage_snapshot(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
     ...
     * @returns {Group}
     */
    join_from_welcome(welcome_bytes, ratchet_tree_bytes) {
        ...
        const ret = wasm.client_join_from_welcome(this.__wbg_ptr, ptr0, len0, ptr1, len1);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return Group.__wrap(ret[0]);
     ...
     */
    key_package() {
        const ret = wasm.client_key_package(this.__wbg_ptr);
        if (ret[3]) {
            throw takeFromExternrefTable0(ret[2]);
        }
        var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
    ...
    load_group(group_id_bytes) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.client_load_group(this.__wbg_ptr, ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return Group.__wrap(ret[0]);
...
export class Group {
     ...
     */
    apply_commit(commit_bytes) {
        const ptr0 = passArray8ToWasm0(commit_bytes, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.group_apply_commit(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    ...
    export_secret(label, context, len) {
        ...
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.group_export_secret(this.__wbg_ptr, ptr0, len0, ptr1, len1, len);
        if (ret[3]) {
            throw takeFromExternrefTable0(ret[2]);
        }
     ...
     */
    group_id_bytes() {
        const ret = wasm.group_group_id_bytes(this.__wbg_ptr);
        var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
        return v1;
    }
    ...
    /**
     * @param {Uint8Array} identity_value
     * @returns {Uint32Array}
     */
    member_indexes_by_identity(identity_value) {
        const ptr0 = passArray8ToWasm0(identity_value, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.group_member_indexes_by_identity(this.__wbg_ptr, ptr0, len0);
     ...
     */
    my_index() {
        const ret = wasm.group_my_index(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     ...
     * @returns {any}
     */
    remove_member(leaves) {
        const ptr0 = passArray32ToWasm0(leaves, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.group_remove_member(this.__wbg_ptr, ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('openmls_lite_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
